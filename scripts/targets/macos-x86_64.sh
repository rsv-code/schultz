...
#
# macOS on Intel. Built on the Mac itself with the Xcode command line tools.
#
...
TARGET_CMAKE_EXTRA="-DCMAKE_OSX_ARCHITECTURES=x86_64"
...
TARGET_CFLAGS_EXTRA="-arch x86_64 -mmacosx-version-min=$MACOSX_DEPLOYMENT_TARGET"
...
# Which libvpx target to configure. as for Linux on x86: pure C rather than a nasm dependency
