...
#
# Android on arm64, cross compiled from Linux or macOS with the NDK.
#
...
# Which libvpx target to configure. NEON through intrinsics, built with the NDK clang
TARGET_VPX=arm64-android-gcc
